...
public class Pet_ListAdapter extends ArrayAdapter {


    List list = new ArrayList();

    public Pet_ListAdapter
    ...
    public View getView(int position, @Nullable final View convertView, @NonNull ViewGroup parent) {
        ...
        Pet_ListAdapter.LayoutHandler layoutHandler;
        if (row == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            row = layoutInflater.inflate(R.layout.row, parent, false);
            layoutHandler = new Pet_ListAdapter.LayoutHandler();
            ...
            layoutHandler = (Pet_ListAdapter.LayoutHandler) row.getTag();
